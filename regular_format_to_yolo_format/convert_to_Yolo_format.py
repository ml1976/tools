# convert from regular labels to yolo labels
# put images into Images folder and you need regular labels text file to be in /Regular-Labels folder
# and you get yolo labels text file in /Yolo-Labels folder
# coding: utf-8
